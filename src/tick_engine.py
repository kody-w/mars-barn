...
PANEL_ARRAY_SCALE = 10  # multiplier vs 100 m2 reference array
...
def get_mars_conditions(ls: float) -> dict:
    ...
    tick_engine and future modules can consume.
    """
...
def tick_colony(colony, current_ls):
    ...
    if global_storm:
        ...
        event_str = f"Regional dust event at Ls {current_ls:.0f}. Solar output reduced."
    elif supply_drop:
        supplies += 50.0
